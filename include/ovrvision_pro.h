...
#define _OV_CAMEYE_ENUM_
  ...
  public:
    ...
    */
    ...
    /*! @brief Capture frame and hold it in GPU for image processing(Grayscale, Skin color extraction etc.)
      @param qt Set an image processing method.
      @return Successful completion of the capture */
    bool Capture(OVR::Camqt qt);
    ...
    */
    ...
    /*! @brief Check GPU specification
      @return true if satisfied for OrvisionPro */
  ...
  protected:
    ...
    // Ovrvision OpenCL implementation
    OvrvisionProOpenCL*     m_pOpenCL;

    // Frame buffer to received 16 bit image from webcam
    unsigned short*         m_pFrame;
    // Left and right eye buffers to receive separated 8 bit images
